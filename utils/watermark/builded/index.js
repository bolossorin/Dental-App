      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        function atPos(xFn, yFn, alpha) {
          ...
          return function (target, watermark) {
            ...
            context.drawImage(
              watermark,
              xFn(target, watermark),
              yFn(target, watermark)
            );
            context.restore();
            return target;
          };
        ...
        function text_atPos(xFn, yFn, text, font, fillStyle, alpha) {
          ...
          return function (target) {
            ...
            context.fillText(
              text,
              xFn(target, metrics, context),
              yFn(target, metrics, context)
            );
            context.restore();
            return target;
          };
