  ...
  return (
    <div className="gallery-image-box">
      <ImageGallery
        ...
        items={[{original: photo.imageBeforeUrl}, {original: photo.imageAfterUrl}]} />
      <div className="gallery-image-description">
        <p className="gallery-image-title">{currentKey === photo.key ? currentTitle : photo.titleBefore}</p>
        <p className="gallery-image-text">{currentKey === photo.key ? currentTag : photo.altTagsBefore}</p>
        <img
